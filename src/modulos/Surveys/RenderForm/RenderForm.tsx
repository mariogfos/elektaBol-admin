              ...
              {formState?.destiny >= 0 &&
                ...
                (aff > 0 && formState?.affCount >= 0 ? (
                  <div>
                    ...
                    <p className={styles.subtitle}>
                      Cuentas con un público de {formState.affCount} afiliados,
                      considerando este dato necesitas llegar a una muestra de{" "}
                      {calculatePercentage(formState.affCount, 10)} afiliados
                      equivalentes al 10% para obtener un volumen relevante de
                      respuestas.
                    </p>
                    <p
